...
from app.models.responses import UnSearchResponse, AsyncTaskResponse, SearchResult
from app.api.dependencies import (
    ApiKeyDep, SettingsDep, DatabaseDep, 
    CacheDep, ClientInfoDep
)
from app.services.search.multi_search import get_multi_search_service, SearchOptions
from app.services.scraping.multi_engine_scraper import get_multi_engine_service, EngineType
from app.services.automation.llm_configuration import get_llm_config_service, generate_config_from_prompt
from app.services.infrastructure.batch_operations import get_batch_service
from app.services.extraction.multi_entity_extraction import (
    get_multi_entity_service, 
    MultiEntityExtractionRequest,
    ExtractionStrategy
)
from app.services.automation.actions_system import get_actions_service, execute_browser_actions
from app.services.crawling.website_mapping import get_website_mapper, MapOptions, MapStrategy
from app.services.crawling.change_tracking import get_change_tracking_service, ChangeTrackingConfig
from app.services.extraction.attributes_extraction import get_attributes_extractor, AttributeExtractionRule, AttributeProcessingType
...
async def extract_attributes_endpoint(
    ...
    try:
        ...
        from app.services.extraction.attributes_extraction import AttributesExtractionConfig
