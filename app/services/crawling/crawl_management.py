...
from app.services.infrastructure.dispatcher import get_memory_adaptive_dispatcher
...
class CrawlManager:
    ...
    async def _post_process_job(self, job: CrawlJob):
        ...
        if job.options.zero_data_retention:
            from app.services.infrastructure.zero_retention import get_zero_retention_manager, DataType
