...
from app.models.requests import (
    UnSearchRequest, BatchSearchRequest, ScrapingConfig,
...
from app.services.scraping.multi_engine_scraper import get_multi_engine_service
...
from app.services.extraction.multi_entity_extraction import get_multi_entity_service, MultiEntityExtractionRequest
...
@router.post("/search", response_model=UnSearchResponse)
...
async def _prepare_enhanced_scraping_config(request_data: UnSearchRequest) -> ScrapingConfig:
...
def _get_enhanced_features_summary(request_data: UnSearchRequest) -> Dict[str, Any]:
